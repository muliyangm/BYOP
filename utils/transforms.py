...
def get_transforms(mode, dataset, num_views=None):
    ...
    mean, std = {
        ...
        "tiny-imagenet": [(0.480, 0.448, 0.398), (0.230, 0.227, 0.226)],
    }[dataset]
                    ...
                    [
                        transforms.RandomChoice(
                            [
                                ...
                                transforms.RandomResizedCrop(64, (0.6, 1.0))
                            ]
                        ),
                        transforms.RandomHorizontalFlip(),
                        transforms.RandomApply([transforms.ColorJitter(0.3, 0.3, 0.15, 0.1)], p=0.5),
                        transforms.RandomGrayscale(p=0.1),
                        transforms.ToTensor(),
                        transforms.Normalize(mean, std),
                    ]
